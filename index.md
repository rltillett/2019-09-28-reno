...
venue: "Data Carpentry Genomics @ University of Nevada Reno"        # brief name of host site without address (e.g., "Euphoric State University")
...
enddate: 2019-09-29        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Richard L Tillett", "Yanji Xu"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Joey Wilcox", "Anthony Harrington", "Chandra Sarkar", "Juli Petereit", "Alexander Selvey", "Sean O'Shannon"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["rltillett@unr.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: "https://pad.carpentries.org/2019-09-28-reno"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
